...
class DivisionAdvance extends StatefulWidget {
  const DivisionAdvance({Key? key}) : super(key: key);

  @override
  State<DivisionAdvance> createState() => _DivisionAdvanceState();
}

class _DivisionAdvanceState extends State<DivisionAdvance>
  ...
  void initState() {
    super.initState();
    DivisionQuestionList.questions.shuffle(Random());
  ...
  void moveToNextQuestion() {
    Future.delayed(const Duration(seconds: 2), () {
      setState(() {
        if (currentQuestionIndex < DivisionQuestionList.questions.length - 1) {
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text(
                      DivisionQuestionList.questions[currentQuestionIndex].question,
              ...
              ..._buildOptions(DivisionQuestionList.questions[currentQuestionIndex].options),
            ],
          ),
        ),
      ),
              ...
              child: Padding(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    bool correct = options[i] ==
                        DivisionQuestionList.questions[currentQuestionIndex].answer;
