...
class MultiplicationAdvance extends StatefulWidget {
  const MultiplicationAdvance({Key? key}) : super(key: key);

  @override
  State<MultiplicationAdvance> createState() => _MultiplicationAdvanceState();
}

class _MultiplicationAdvanceState extends State<MultiplicationAdvance>
  ...
  void initState() {
    super.initState();
    MultiplicationQuestionlist.questions.shuffle(Random());
  ...
  void checkAnswer(String selectedAnswer) {
    ...
    bool correct = selectedAnswer ==
        MultiplicationQuestionlist.questions[currentQuestionIndex].answer;
  ...
  void moveToNextQuestion() {
    Future.delayed(const Duration(seconds: 2), () {
      setState(() {
        if (currentQuestionIndex < MultiplicationQuestionlist.questions.length - 1) {
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text(
                      MultiplicationQuestionlist.questions[currentQuestionIndex].question,
              ...
              ..._buildOptions(MultiplicationQuestionlist.questions[currentQuestionIndex].options),
            ],
          ),
        ),
      ),
