...
class SubtractionAdvance extends StatefulWidget {
  const SubtractionAdvance({Key? key}) : super(key: key);

  @override
  State<SubtractionAdvance> createState() => _SubtractionAdvanceState();
}

class _SubtractionAdvanceState extends State<SubtractionAdvance>
  ...
  void initState() {
    super.initState();
    SubtractionQuestionList.questions.shuffle(Random());
  ...
  void checkAnswer(String selectedAnswer) {
    ...
    bool correct = selectedAnswer ==
        SubtractionQuestionList.questions[currentQuestionIndex].answer;
  ...
  void moveToNextQuestion() {
    Future.delayed(const Duration(seconds: 2), () {
      setState(() {
        if (currentQuestionIndex < SubtractionQuestionList.questions.length - 1) {
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text(
                      SubtractionQuestionList.questions[currentQuestionIndex].question,
              ...
              ..._buildOptions(SubtractionQuestionList.questions[currentQuestionIndex].options),
            ],
          ),
        ),
      ),
